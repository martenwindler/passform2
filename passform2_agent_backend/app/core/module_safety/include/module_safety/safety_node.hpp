...
#ifndef PASSFORM_MODULE__SAFETY_NODE_HPP
#define PASSFORM_MODULE__SAFETY_NODE_HPP
...
class SafetyNode : public rclcpp_lifecycle::LifecycleNode
{
 ...
 private:
  ...
  // Initialization SafetyNode
  void plugin_node();

  // Shutdown SafetyNode
  void unplug_node();

  // Declare status of SafetyNode
  void run();

  // Declare status of SafetyNode
  void stop();

  // Declare SafetyNode name. This variable will be set by parameters
  std::string node_name_;

  // Declare SafetyNode state. This variable will be changed by lifecycle state
...
} // passform_module_safety
#endif // PASSFORM_MODULE__SAFETY_NODE_HPP
