...
run = LED(adc.RUN)
col = PiIO_col()
PWM1 = PWMLED(adc.PWM1) #Analog Out
...
while True:
	print("analog inputs")
	print("Input channel one:")
	data = adc.get_scaled(adc.AI1)
	print (data)
	data = adc.get_raw(adc.AI1)
	print (data)

	print("Input channel two:")
	data = adc.get_scaled(adc.AI2)
	print (data)
	data = adc.get_raw(adc.AI2)
	print (data)

	print("Input channel three:")
	data = adc.get_scaled(adc.AI3)
	print (data)
	data = adc.get_raw(adc.AI3)
	print (data)

	print("Input channel four:")
	data = adc.get_scaled(adc.AI4)
	print (data)
	data = adc.get_raw(adc.AI4)
	print (data)
	print()
	print()
