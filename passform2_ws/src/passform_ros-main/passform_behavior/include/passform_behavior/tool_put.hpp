...
class ToolPut: public RosActionNode<passform_msgs::action::Passform>
{
public:
  ToolPut(const std::string& name,
...
const std::vector<std::string> ToolPut::float_ports{};
const std::vector<std::string> ToolPut::string_ports{"tool_id", "end_pos"};
const std::vector<std::string> ToolPut::int_ports{"task_id"};
const std::vector<std::string> ToolPut::bool_ports{};
const uint ToolPut::skill_type{passform_msgs::msg::SkillType::TOOL_PUT};