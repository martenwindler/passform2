...
class AssemblyMount: public RosActionNode<passform_msgs::action::Passform>
{
public:
  AssemblyMount(const std::string& name,
...
const std::vector<std::string> AssemblyMount::float_ports{"a_max", "v_max", "F_max", "M_max"};
const std::vector<std::string> AssemblyMount::string_ports{"uuid", "end_pos"};
const std::vector<std::string> AssemblyMount::int_ports{"task_id"};
const std::vector<std::string> AssemblyMount::bool_ports{};
const uint AssemblyMount::skill_type{passform_msgs::msg::SkillType::ASSEMBLY_MOUNT};