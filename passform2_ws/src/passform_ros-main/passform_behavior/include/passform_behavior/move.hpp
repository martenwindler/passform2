...
class Move: public RosActionNode<passform_msgs::action::Passform>
{
public:
...
const std::vector<std::string> Move::float_ports{"a_max", "v_max"};
const std::vector<std::string> Move::string_ports{"uuid", "end_pos"};
const std::vector<std::string> Move::int_ports{"task_id"};
const std::vector<std::string> Move::bool_ports{};
const uint Move::skill_type{passform_msgs::msg::SkillType::MOVE};