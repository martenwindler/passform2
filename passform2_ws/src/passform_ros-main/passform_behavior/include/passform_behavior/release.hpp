...
class Release: public RosActionNode<passform_msgs::action::Passform>
{
public:
...
const std::vector<std::string> Release::float_ports{};
const std::vector<std::string> Release::string_ports{"uuid"};
const std::vector<std::string> Release::int_ports{"task_id"};
const std::vector<std::string> Release::bool_ports{};
const uint Release::skill_type{passform_msgs::msg::SkillType::RELEASE};