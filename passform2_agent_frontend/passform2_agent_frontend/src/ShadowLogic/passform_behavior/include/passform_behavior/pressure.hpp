...
class Pressure: public RosActionNode<passform_msgs::action::Passform>
{
public:
...
const std::vector<std::string> Pressure::float_ports{"F_max", "M_max"};
const std::vector<std::string> Pressure::string_ports{"uuid"};
const std::vector<std::string> Pressure::int_ports{"task_id"};
const std::vector<std::string> Pressure::bool_ports{};
const uint Pressure::skill_type{passform_msgs::msg::SkillType::PRESSURE};