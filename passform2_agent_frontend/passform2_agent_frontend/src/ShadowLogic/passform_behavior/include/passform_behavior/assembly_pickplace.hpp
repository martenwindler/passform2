...
class AssemblyPickplace: public RosActionNode<passform_msgs::action::Passform>
{
public:
  AssemblyPickplace(const std::string& name,
...
const std::vector<std::string> AssemblyPickplace::float_ports{"a_max", "v_max", "F_max", "M_max"};
const std::vector<std::string> AssemblyPickplace::string_ports{"uuid", "end_pos"};
const std::vector<std::string> AssemblyPickplace::int_ports{"task_id"};
const std::vector<std::string> AssemblyPickplace::bool_ports{};
const uint AssemblyPickplace::skill_type{passform_msgs::msg::SkillType::ASSEMBLY_PICKPLACE};