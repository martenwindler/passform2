...
class ToolUse: public RosActionNode<passform_msgs::action::Passform>
{
public:
  ToolUse(const std::string& name,
...
const std::vector<std::string> ToolUse::float_ports{};
const std::vector<std::string> ToolUse::string_ports{"uuid", "task_id", "tool_id"};
const std::vector<std::string> ToolUse::int_ports{"task_id"};
const std::vector<std::string> ToolUse::bool_ports{};
const uint ToolUse::skill_type{passform_msgs::msg::SkillType::TOOL_USE};