...
class AssemblyScrew: public RosActionNode<passform_msgs::action::Passform>
{
public:
  AssemblyScrew(const std::string& name,
...
const std::vector<std::string> AssemblyScrew::float_ports{"a_max", "v_max", "F_max", "M_max"};
const std::vector<std::string> AssemblyScrew::string_ports{"uuid", "screw_id"};
const std::vector<std::string> AssemblyScrew::int_ports{"task_id"};
const std::vector<std::string> AssemblyScrew::bool_ports{};
const uint AssemblyScrew::skill_type{passform_msgs::msg::SkillType::ASSEMBLY_SCREW};