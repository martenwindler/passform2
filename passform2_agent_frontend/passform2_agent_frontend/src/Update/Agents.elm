...
{-| 
    ...
    Inklusive Steuerung der sliding Sidebar.
-}
...
update msg model =
    case msg of
        ...
        ToggleSidebar -> 
            -- Schaltet den Slide-Zustand einfach um (» / « Button)
            ( { model | sidebarOpen = not model.sidebarOpen }, Cmd.none )

        SwitchSidebarTab tab -> 
            -- Wenn ein Tab gewählt wird, wechseln wir den Inhalt 
            -- UND stellen sicher, dass die Sidebar aufslidet (True)
            ( { model 
