...
class ToolGet: public RosActionNode<passform_msgs::action::Passform>
{
public:
  ToolGet(const std::string& name,
...
const std::vector<std::string> ToolGet::float_ports{};
const std::vector<std::string> ToolGet::string_ports{"uuid", "task_id", "tool_id"};
const std::vector<std::string> ToolGet::int_ports{"task_id"};
const std::vector<std::string> ToolGet::bool_ports{};
const uint ToolGet::skill_type{passform_msgs::msg::SkillType::TOOL_GET};