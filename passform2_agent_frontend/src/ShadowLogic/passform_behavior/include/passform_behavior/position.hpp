...
class Position: public RosActionNode<passform_msgs::action::Passform>
{
public:
...
const std::vector<std::string> Position::float_ports{"a_max", "v_max", "F_max", "M_max"};
const std::vector<std::string> Position::string_ports{"uuid", "end_pos"};
const std::vector<std::string> Position::int_ports{"task_id"};
const std::vector<std::string> Position::bool_ports{};
const uint Position::skill_type{passform_msgs::msg::SkillType::POSITION};