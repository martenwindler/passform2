...
class PassformAction: public RosActionNode<passform_msgs::action::Passform>
{
public:
  PassformAction(const std::string& name,
  ...
  static BT::PortsList providedPorts()
  {
    ...
    ports_list.insert(InputPort<unsigned>("action_type"));
    return ports_list;
  }
  ...
  bool setGoal(Goal& goal) override
  {
    ...
    goal.task.type.skill_type = getInput<unsigned>("action_type").value();
...
const std::vector<std::string> PassformAction::float_ports{"a_max", "v_max", "F_max", "M_max"};
const std::vector<std::string> PassformAction::string_ports{"uuid", "end_pos", "screw_id"};
const std::vector<std::string> PassformAction::int_ports{"task_id"};
const std::vector<std::string> PassformAction::bool_ports{};
