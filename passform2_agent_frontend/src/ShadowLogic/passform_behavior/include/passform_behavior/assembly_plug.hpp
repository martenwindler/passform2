...
class AssemblyPlug: public RosActionNode<passform_msgs::action::Passform>
{
public:
  AssemblyPlug(const std::string& name,
...
const std::vector<std::string> AssemblyPlug::float_ports{"a_max", "v_max", "F_max", "M_max"};
const std::vector<std::string> AssemblyPlug::string_ports{"uuid", "end_pos"};
const std::vector<std::string> AssemblyPlug::int_ports{"task_id"};
const std::vector<std::string> AssemblyPlug::bool_ports{};
const uint AssemblyPlug::skill_type{passform_msgs::msg::SkillType::ASSEMBLY_PLUG};